...
GitMind generates professional Git commit messages from your changes without leaving VS Code. It supports **18 provider choices**: 17 built-in AI providers, including local Ollama and GitHub Copilot, plus a **Pro Custom API** option.
